...
ensures   (!((top.Chan2_1.Cmd == GntE) && (top.AChan2_1.Cmd == Inv)))
...
requires (!((top.Chan2_1.Cmd == GntE) && (top.AInvSet_1 == true)))//3//guard condition
...
requires 
requires (!((top.Chan2_1.Cmd == GntE) && (top.AChan2_1.Cmd == Inv)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__60_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__60_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
