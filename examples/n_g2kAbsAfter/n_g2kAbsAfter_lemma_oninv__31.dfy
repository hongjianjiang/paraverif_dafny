...
ensures   (!((!(top.Cache_1.State == I)) && (top.AChan2_1.Cmd == GntE)))
...
requires (!((top.Chan2_1.Cmd == GntS) && (top.AChan2_1.Cmd == GntE)))//3//guard condition
...
requires (!((!(top.Cache_1.State == I)) && (top.ShrSet_1 == false)))//3//guard condition
...
requires 
requires (!((!(top.Cache_1.State == I)) && (top.AChan2_1.Cmd == GntE)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__31_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__31_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
