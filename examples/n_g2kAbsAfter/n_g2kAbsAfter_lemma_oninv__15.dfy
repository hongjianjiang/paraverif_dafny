...
ensures   (!((!(top.ACache_1.State == I)) && (top.Cache_1.State == E)))
...
requires (!((!(top.ACache_1.State == I)) && (top.Chan2_1.Cmd == GntE)))//3//guard condition
...
requires (!((top.Cache_1.State == E) && (top.AChan2_1.Cmd == GntS)))//3//guard condition
...
requires (!((top.Cache_1.State == E) && (top.AChan2_1.Cmd == GntE)))//3//guard condition
...
requires 
requires (!((!(top.ACache_1.State == I)) && (top.Cache_1.State == E)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__15_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__15_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
