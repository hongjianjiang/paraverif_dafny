...
method n_n_Store_i1inv__10_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.Chan3_1.Cmd == InvAck) && (top.Cache_1.State == E)))//3
//guard condition
requires   (top.Cache_1.State == E)

ensures   (!((!(top.Chan3_1.Data == top.AuxData)) && (top.ExGntd == true) && (top.Chan3_1.Cmd == InvAck)))
...
method n_n_AStore_i1inv__10_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.Chan3_1.Cmd == InvAck) && (top.ACache_1.State == E)))//3
//guard condition
...
requires (top.Cache_1.State == E)//branch//guard condition
...
requires (!((top.Chan3_1.Cmd == InvAck) && (top.ShrSet_1 == false)))//3//guard condition
...
requires 
requires (!((!(top.Chan3_1.Data == top.AuxData)) && (top.ExGntd == true) && (top.Chan3_1.Cmd == InvAck)))//statement has nothing with prop--it guranttee itself
//guard condition
