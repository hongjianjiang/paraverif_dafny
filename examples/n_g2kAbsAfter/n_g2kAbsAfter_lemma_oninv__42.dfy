...
requires (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Empty) && (top.ShrSet_1 == true) && (top.CurCmd == Empty)))//3//guard condition
requires   ((top.CurCmd == Empty) && (!(top.Chan1_1.Cmd == Empty)));
ensures   (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Empty) && (top.InvSet_1 == true)))
...
requires (!((top.ExGntd == true) && (top.Chan2_1.Cmd == GntS)))//3//guard condition
...
requires (!((top.InvSet_1 == true) && (top.ShrSet_1 == false)))//3//guard condition
...
requires 
requires (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Empty) && (top.InvSet_1 == true)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__42_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__42_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
