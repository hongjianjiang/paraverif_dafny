...
ensures   (!((top.ExGntd == true) && (!(top.ACache_1.State == E)) && (top.AChan2_1.Cmd == Inv)))
...
requires (!((top.AShrSet_1 == false) && (top.AChan2_1.Cmd == Inv)))//3//guard condition
...
requires (!((top.ExGntd == true) && (!(top.ACache_1.State == E)) && (top.AChan2_1.Cmd == Empty) && (top.AInvSet_1 == true)))//3//guard condition
...
requires 
requires (!((top.ExGntd == true) && (!(top.ACache_1.State == E)) && (top.AChan2_1.Cmd == Inv)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__27_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__27_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
