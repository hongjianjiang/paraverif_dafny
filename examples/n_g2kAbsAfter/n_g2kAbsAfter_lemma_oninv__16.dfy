...
method n_n_Store_i1inv__16_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.Cache_1.State == E) && (top.AChan2_1.Cmd == GntS)))//3
//guard condition
requires   (top.Cache_1.State == E)

ensures   (!((!(top.AChan2_1.Data == top.AuxData)) && (top.AChan2_1.Cmd == GntS)))
...
method n_n_AStore_i1inv__16_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.AChan2_1.Cmd == GntS) && (top.ACache_1.State == E)))//3
//guard condition
...
requires (!((top.ExGntd == false) && (!(top.MemData == top.AuxData))))//3//guard condition
...
requires 
requires (!((!(top.AChan2_1.Data == top.AuxData)) && (top.AChan2_1.Cmd == GntS)))//statement has nothing with prop--it guranttee itself
//guard condition
