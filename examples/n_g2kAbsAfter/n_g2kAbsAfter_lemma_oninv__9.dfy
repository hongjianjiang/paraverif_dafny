...
ensures   (!((top.ExGntd == false) && (top.ACache_1.State == E)))
...
requires 
requires (!((top.ExGntd == false) && (top.ACache_1.State == E)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__9_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__9_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
