...
ensures   (!((!(top.ACache_1.State == I)) && (top.AShrSet_1 == false)))
...
requires (!((!(top.ACache_1.State == I)) && (top.AChan3_1.Cmd == InvAck)))//3//guard condition
...
requires (!((top.AShrSet_1 == false) && (top.AChan2_1.Cmd == GntS)))//3//guard condition
...
requires (!((top.AShrSet_1 == false) && (top.AChan2_1.Cmd == GntE)))//3//guard condition
...
requires 
requires (!((!(top.ACache_1.State == I)) && (top.AShrSet_1 == false)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__51_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__51_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
