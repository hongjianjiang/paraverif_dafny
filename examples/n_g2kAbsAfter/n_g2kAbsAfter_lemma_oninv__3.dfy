...
method n_n_Store_i1inv__3_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
ensures   (!((!(top.Cache_1.State == I)) && (!(top.Cache_1.Data == top.AuxData))))
...
method n_n_AStore_i1inv__3_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((!(top.Cache_1.State == I)) && (top.ACache_1.State == E)))//3
//guard condition
...
requires (!((!(top.Chan2_1.Data == top.AuxData)) && (top.Chan2_1.Cmd == GntS)))//3//guard condition
...
requires (!((!(top.Chan2_1.Data == top.AuxData)) && (top.Chan2_1.Cmd == GntE)))//3//guard condition
...
requires 
requires (!((!(top.Cache_1.State == I)) && (!(top.Cache_1.Data == top.AuxData))))//statement has nothing with prop--it guranttee itself
//guard condition
