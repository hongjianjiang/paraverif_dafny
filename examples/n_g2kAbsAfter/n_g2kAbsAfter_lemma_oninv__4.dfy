...
method n_n_Store_i1inv__4_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.ExGntd == false) && (top.Cache_1.State == E)))//3
//guard condition
requires   (top.Cache_1.State == E)

ensures   (!((top.ExGntd == false) && (!(top.MemData == top.AuxData))))
...
method n_n_AStore_i1inv__4_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.ExGntd == false) && (top.ACache_1.State == E)))//3
//guard condition
...
requires 
requires (!((top.ExGntd == false) && (!(top.MemData == top.AuxData))))//statement has nothing with prop--it guranttee itself
//guard condition
