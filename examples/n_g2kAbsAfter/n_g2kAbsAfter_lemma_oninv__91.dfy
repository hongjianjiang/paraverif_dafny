...
ensures   (!((top.AChan2_1.Cmd == Inv) && (top.CurCmd == ReqS) && (top.Chan3_1.Cmd == InvAck)))
...
requires (!((top.Chan2_1.Cmd == Inv) && (top.CurCmd == ReqS) && (top.AChan2_1.Cmd == Inv)))//3//guard condition
...
requires (!((top.CurCmd == ReqS) && (top.Chan3_1.Cmd == InvAck) && (top.AInvSet_1 == true)))//3//guard condition
...
requires 
requires (!((top.AChan2_1.Cmd == Inv) && (top.CurCmd == ReqS) && (top.Chan3_1.Cmd == InvAck)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__91_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__91_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
