...
ensures   (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Empty) && (top.ShrSet_1 == true) && (top.CurCmd == Empty)))
...
requires (!((top.CurCmd == Empty) && (top.Chan2_1.Cmd == Inv)))//3//guard condition
...
requires 
requires (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Empty) && (top.ShrSet_1 == true) && (top.CurCmd == Empty)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__55_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__55_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
