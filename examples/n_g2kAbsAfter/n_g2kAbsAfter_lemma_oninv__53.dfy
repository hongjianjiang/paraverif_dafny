...
requires (!((top.ACache_1.State == E) && (top.ShrSet_1 == true)))//3//guard condition
requires   ((top.CurCmd == Empty) && (!(top.Chan1_1.Cmd == Empty)));
ensures   (!((top.ACache_1.State == E) && (top.InvSet_1 == true)))
...
requires 
requires (!((top.ACache_1.State == E) && (top.InvSet_1 == true)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__53_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__53_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
