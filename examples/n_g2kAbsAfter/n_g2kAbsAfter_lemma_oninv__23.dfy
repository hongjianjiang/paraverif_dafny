...
ensures   (!((top.Chan3_1.Cmd == InvAck) && (top.ShrSet_1 == false)))
...
requires 
requires (!((top.Chan3_1.Cmd == InvAck) && (top.ShrSet_1 == false)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__23_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__23_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
