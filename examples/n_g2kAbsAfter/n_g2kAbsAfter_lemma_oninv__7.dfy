...
ensures   (!((top.Cache_1.State == E) && (top.AChan2_1.Cmd == GntE)))
...
requires 
requires (!((top.Cache_1.State == E) && (top.AChan2_1.Cmd == GntE)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__7_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__7_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
