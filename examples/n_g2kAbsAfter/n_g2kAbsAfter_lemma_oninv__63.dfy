...
requires (!((top.AInvSet_1 == true) && (top.AChan3_1.Cmd == InvAck)))//3//guard condition
requires   ((top.AChan2_1.Cmd == Empty) && (top.AInvSet_1 == true) && (top.CurCmd == ReqE));
ensures   (!((top.AChan2_1.Cmd == Inv) && (top.AChan3_1.Cmd == InvAck)))
...
requires 
requires (!((top.AChan2_1.Cmd == Inv) && (top.AChan3_1.Cmd == InvAck)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__63_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__63_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
