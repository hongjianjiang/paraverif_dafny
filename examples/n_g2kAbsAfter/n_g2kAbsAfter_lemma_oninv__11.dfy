...
method n_n_Store_i1inv__11_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.AChan3_1.Cmd == InvAck) && (top.Cache_1.State == E)))//3
//guard condition
requires   (top.Cache_1.State == E)

ensures   (!((!(top.AChan3_1.Data == top.AuxData)) && (top.ExGntd == true) && (top.AChan3_1.Cmd == InvAck)))
...
method n_n_AStore_i1inv__11_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.AChan3_1.Cmd == InvAck) && (top.ACache_1.State == E)))//3
//guard condition
...
requires (!((top.AChan3_1.Cmd == InvAck) && (top.AShrSet_1 == false)))//3//guard condition
...
requires (top.ACache_1.State == E)//branch//guard condition
...
requires 
requires (!((!(top.AChan3_1.Data == top.AuxData)) && (top.ExGntd == true) && (top.AChan3_1.Cmd == InvAck)))//statement has nothing with prop--it guranttee itself
//guard condition
