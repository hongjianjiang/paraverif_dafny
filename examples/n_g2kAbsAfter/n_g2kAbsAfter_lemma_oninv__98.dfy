...
requires (!((top.ShrSet_1 == true) && (top.AShrSet_1 == true) && (top.ExGntd == true)))//3//guard condition
requires   ((top.CurCmd == Empty) && (!(top.Chan1_1.Cmd == Empty)));
ensures   (!((top.InvSet_1 == true) && (top.AInvSet_1 == true) && (top.ExGntd == true)))
...
requires 
requires (!((top.InvSet_1 == true) && (top.AInvSet_1 == true) && (top.ExGntd == true)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__98_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__98_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
