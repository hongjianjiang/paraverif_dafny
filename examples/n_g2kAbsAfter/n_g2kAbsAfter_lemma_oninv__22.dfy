...
requires (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Empty) && (top.InvSet_1 == true)))//3//guard condition
requires   ((top.Chan2_1.Cmd == Empty) && (top.CurCmd == ReqE) && (top.InvSet_1 == true));
ensures   (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Inv)))
...
requires (!((top.Chan2_1.Cmd == Inv) && (top.ShrSet_1 == false)))//3//guard condition
...
requires 
requires (!((top.ExGntd == true) && (!(top.Cache_1.State == E)) && (top.Chan2_1.Cmd == Inv)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__22_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__22_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
