...
ensures   (!((top.ShrSet_1 == true) && (top.AShrSet_1 == true) && (top.ExGntd == true)))
...
requires 
requires (!((top.ShrSet_1 == true) && (top.AShrSet_1 == true) && (top.ExGntd == true)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__99_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__99_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
