...
ensures   (!((top.AShrSet_1 == false) && (top.AInvSet_1 == true)))
...
requires 
requires (!((top.AShrSet_1 == false) && (top.AInvSet_1 == true)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__62_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__62_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
