...
ensures   (!((top.ACache_1.State == E) && (top.AShrSet_1 == false)))
...
requires (!((top.AChan3_1.Cmd == InvAck) && (top.ACache_1.State == E)))//3//guard condition
...
requires 
requires (!((top.ACache_1.State == E) && (top.AShrSet_1 == false)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__18_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__18_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
