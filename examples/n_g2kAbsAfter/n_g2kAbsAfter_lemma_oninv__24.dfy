...
ensures   (!((top.AChan3_1.Cmd == InvAck) && (top.Cache_1.State == E)))
...
requires (!((top.AChan3_1.Cmd == InvAck) && (top.Chan2_1.Cmd == GntE)))//3//guard condition
...
requires (!((top.Cache_1.State == E) && (top.AChan2_1.Cmd == Inv)))//3//guard condition
...
requires 
requires (!((top.AChan3_1.Cmd == InvAck) && (top.Cache_1.State == E)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__24_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__24_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
