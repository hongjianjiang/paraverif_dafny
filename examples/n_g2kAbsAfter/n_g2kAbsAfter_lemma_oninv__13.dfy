...
method n_n_Store_i1inv__13_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.Chan2_1.Cmd == GntS) && (top.Cache_1.State == E)))//3
//guard condition
requires   (top.Cache_1.State == E)

ensures   (!((!(top.Chan2_1.Data == top.AuxData)) && (top.Chan2_1.Cmd == GntS)))
...
method n_n_AStore_i1inv__13_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.ACache_1.State == E) && (top.Chan2_1.Cmd == GntS)))//3
//guard condition
...
requires 
requires (!((!(top.Chan2_1.Data == top.AuxData)) && (top.Chan2_1.Cmd == GntS)))//statement has nothing with prop--it guranttee itself
//guard condition
