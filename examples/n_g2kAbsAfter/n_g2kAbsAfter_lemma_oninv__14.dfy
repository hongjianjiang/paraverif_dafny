...
method n_n_Store_i1inv__14_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.Chan2_1.Cmd == GntE) && (top.Cache_1.State == E)))//3
//guard condition
requires   (top.Cache_1.State == E)

ensures   (!((!(top.Chan2_1.Data == top.AuxData)) && (top.Chan2_1.Cmd == GntE)))
...
method n_n_AStore_i1inv__14_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
requires (!((top.ACache_1.State == E) && (top.Chan2_1.Cmd == GntE)))//3
//guard condition
...
requires 
requires (!((!(top.Chan2_1.Data == top.AuxData)) && (top.Chan2_1.Cmd == GntE)))//statement has nothing with prop--it guranttee itself
//guard condition
