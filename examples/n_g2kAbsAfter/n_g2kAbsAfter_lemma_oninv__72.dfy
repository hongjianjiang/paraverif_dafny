...
ensures   (!((top.ACache_1.State == E) && (top.ShrSet_1 == true)))
...
requires (!((top.ExGntd == false) && (top.ACache_1.State == E)))//3//guard condition
...
requires (!((top.ACache_1.State == E) && (top.AShrSet_1 == false)))//3//guard condition
...
requires (!((top.ShrSet_1 == true) && (top.AChan2_1.Cmd == GntE)))//3//guard condition
...
requires 
requires (!((top.ACache_1.State == E) && (top.ShrSet_1 == true)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__72_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__72_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
