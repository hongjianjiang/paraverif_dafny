...
ensures   (!((top.AShrSet_1 == false) && (top.AChan2_1.Cmd == GntS)))
...
requires 
requires (!((top.AShrSet_1 == false) && (top.AChan2_1.Cmd == GntS)))//statement has nothing with prop--it guranttee itself
//guard condition
...
method n_n_Store_i1inv__71_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
...
method n_n_AStore_i1inv__71_0(top:TopC,d:nat, N4:nat )
requires 0<= d<N4
