(*  Title:      HOL/Auth/n_mutualExDeadFree_lemma_on_inv__2.thy
...
theory n_mutualExDeadFree_lemma_on_inv__2 imports n_mutualExDeadFree_base
begin
...
have "(i=p__Inv0)\<or>(i=p__Inv1)" apply (cut_tac a1 a2, auto) done
moreover {
  assume b1: "(i=p__Inv0)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (andForm (eqn (IVar (Para (Ident ''n'') p__Inv0)) (Const I)) (eqn (IVar (Para (Ident ''n'') p__Inv1)) (Const I))) (eqn (IVar (Ident ''x'')) (Const false))))" in exI, auto) done
