(*  Title:      HOL/Auth/n_mutualExDeadFree_base.thy
...
theory n_mutualExDeadFree_base imports paraTheory
begin
...
(neg (andForm (andForm (eqn (IVar (Para (Ident ''n'') p__Inv0)) (Const I)) (eqn (IVar (Para (Ident ''n'') p__Inv1)) (Const T))) (eqn (IVar (Ident ''x'')) (Const false))))"

definition inv__3::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__3 p__Inv0 p__Inv1 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''n'') p__Inv0)) (Const I)) (eqn (IVar (Para (Ident ''n'') p__Inv1)) (Const I))) (eqn (IVar (Ident ''x'')) (Const false))))"
