(*  Title:      HOL/Auth/n_mutualExDeadFree_lemma_inv__4_on_rules.thy
...
theory n_mutualExDeadFree_lemma_inv__4_on_rules imports n_mutualExDeadFree_lemma_on_inv__4
begin
section{*All lemmas on causal relation between inv__4*}
lemma lemma_inv__4_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv0 p__Inv1 p__Inv2. p__Inv0\<le>N\<and>p__Inv1\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv1\<and>p__Inv0~=p__Inv2\<and>p__Inv1~=p__Inv2\<and>f=inv__4  p__Inv0 p__Inv1 p__Inv2)"
