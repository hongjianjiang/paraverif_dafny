(*  Title:      HOL/Auth/n_mutualExDeadFree_lemma_on_inv__1.thy
...
theory n_mutualExDeadFree_lemma_on_inv__1 imports n_mutualExDeadFree_base
begin
...
moreover {
  assume b1: "(i=p__Inv0)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (andForm (eqn (IVar (Para (Ident ''n'') p__Inv0)) (Const I)) (eqn (IVar (Para (Ident ''n'') p__Inv1)) (Const T))) (eqn (IVar (Ident ''x'')) (Const false))))" in exI, auto) done
