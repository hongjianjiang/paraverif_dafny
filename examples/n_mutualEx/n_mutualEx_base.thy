...
(neg (andForm (eqn (IVar (Ident ''x'')) (Const true)) (eqn (IVar (Para (Ident ''n'') p__Inv4)) (Const C))))"

definition inv__3::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__3 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''n'') p__Inv4)) (Const E)) (eqn (IVar (Para (Ident ''n'') p__Inv3)) (Const C))))"

definition inv__4::"nat \<Rightarrow> formula" where [simp]:
"inv__4 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Ident ''x'')) (Const true)) (eqn (IVar (Para (Ident ''n'') p__Inv4)) (Const E))))"

definition inv__5::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__5 p__Inv3 p__Inv4 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''n'') p__Inv4)) (Const E)) (eqn (IVar (Para (Ident ''n'') p__Inv3)) (Const E))))"
