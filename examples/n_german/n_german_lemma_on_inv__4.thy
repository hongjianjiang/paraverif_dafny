(*  Title:      HOL/Auth/n_german_lemma_on_inv__4.thy
...
moreover {
  assume b1: "(i~=p__Inv2)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') i) ''State'')) (Const E)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const I)))))" in exI, auto) done
  then have "invHoldForRule s f r (invariants N)" by auto
}
moreover {
  assume b1: "(i~=p__Inv2)"
...
lemma n_SendReqE__part__1Vsinv__4:
...
lemma n_SendInv__part__0Vsinv__4:
...
lemma n_SendReqE__part__0Vsinv__4:
...
lemma n_SendInv__part__1Vsinv__4:
