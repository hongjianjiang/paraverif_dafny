...
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntS)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv0) ''State'')) (Const E))))"

definition inv__6::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__6 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const GntE)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const I)))))"

definition inv__7::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__7 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv0) ''State'')) (Const E))))"

definition inv__8::"nat \<Rightarrow> formula" where [simp]:
"inv__8 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)) (eqn (IVar (Ident ''ExGntd'')) (Const false))))"

definition inv__9::"nat \<Rightarrow> formula" where [simp]:
"inv__9 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (neg (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Data'')) (IVar (Ident ''AuxData''))))))"

definition inv__10::"nat \<Rightarrow> formula" where [simp]:
"inv__10 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntS)) (neg (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Data'')) (IVar (Ident ''AuxData''))))))"

definition inv__11::"nat \<Rightarrow> formula" where [simp]:
"inv__11 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (neg (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Data'')) (IVar (Ident ''AuxData''))))))"

definition inv__12::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__12 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const GntS))))"

definition inv__13::"nat \<Rightarrow> formula" where [simp]:
"inv__13 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const I)))))"

definition inv__14::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__14 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE))))"

definition inv__15::"nat \<Rightarrow> formula" where [simp]:
"inv__15 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E))))"

definition inv__16::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__16 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv0) ''State'')) (Const E))))"

definition inv__17::"nat \<Rightarrow> formula" where [simp]:
"inv__17 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Ident ''ExGntd'')) (Const false))))"

definition inv__18::"nat \<Rightarrow> formula" where [simp]:
"inv__18 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''Data'')) (IVar (Ident ''AuxData''))))))"

definition inv__19::"nat \<Rightarrow> formula" where [simp]:
"inv__19 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)))) (eqn (IVar (Ident ''ExGntd'')) (Const true))))"

definition inv__20::"nat \<Rightarrow> formula" where [simp]:
"inv__20 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"

definition inv__21::"nat \<Rightarrow> formula" where [simp]:
"inv__21 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntS))))"

definition inv__22::"nat \<Rightarrow> formula" where [simp]:
"inv__22 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE))))"

definition inv__23::"nat \<Rightarrow> nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__23 p__Inv0 p__Inv1 p__Inv2 \<equiv>
(neg (andForm (andForm (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv0)) (Const false)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false))) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv1)) (Const false))) (neg (eqn (IVar (Ident ''MemData'')) (IVar (Ident ''AuxData''))))))"

definition inv__24::"nat \<Rightarrow> formula" where [simp]:
"inv__24 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntS))))"

definition inv__25::"nat \<Rightarrow> formula" where [simp]:
"inv__25 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const I)))))"

definition inv__26::"nat \<Rightarrow> formula" where [simp]:
"inv__26 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false))))"

definition inv__27::"nat \<Rightarrow> formula" where [simp]:
"inv__27 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"

definition inv__28::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__28 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const Inv)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E))))"

definition inv__29::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__29 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv0) ''Cmd'')) (Const InvAck))))"

definition inv__30::"nat \<Rightarrow> formula" where [simp]:
"inv__30 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Empty))) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''Data'')) (IVar (Ident ''AuxData''))))))"

definition inv__31::"nat \<Rightarrow> formula" where [simp]:
"inv__31 p__Inv2 \<equiv>
(neg (andForm (andForm (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Empty))) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)))))"

definition inv__32::"nat \<Rightarrow> formula" where [simp]:
"inv__32 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv))))"

definition inv__33::"nat \<Rightarrow> formula" where [simp]:
"inv__33 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntS))))"

definition inv__34::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__34 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true)) (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv0) ''State'')) (Const E))))"

definition inv__35::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__35 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const GntE)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv))))"

definition inv__36::"nat \<Rightarrow> formula" where [simp]:
"inv__36 p__Inv2 \<equiv>
(neg (andForm (andForm (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''Data'')) (IVar (Ident ''AuxData'')))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Empty))) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const true))))"

definition inv__37::"nat \<Rightarrow> formula" where [simp]:
"inv__37 p__Inv2 \<equiv>
(neg (andForm (andForm (andForm (andForm (eqn (IVar (Ident ''CurCmd'')) (Const Empty)) (neg (eqn (IVar (Field (Para (Ident ''Cache'') p__Inv2) ''State'')) (Const E)))) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Empty))) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const true))))"

definition inv__38::"nat \<Rightarrow> formula" where [simp]:
"inv__38 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true))))"

definition inv__39::"nat \<Rightarrow> formula" where [simp]:
"inv__39 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const false)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true))))"

definition inv__40::"nat \<Rightarrow> formula" where [simp]:
"inv__40 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntS)) (eqn (IVar (Ident ''ExGntd'')) (Const true))))"

definition inv__41::"nat \<Rightarrow> formula" where [simp]:
"inv__41 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv))))"

definition inv__42::"nat \<Rightarrow> formula" where [simp]:
"inv__42 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Ident ''ExGntd'')) (Const false)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"

definition inv__43::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__43 p__Inv0 p__Inv2 \<equiv>
...
"inv__44 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const GntE)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv0)) (Const true))))"

definition inv__45::"nat \<Rightarrow> formula" where [simp]:
"inv__45 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (eqn (IVar (Ident ''CurCmd'')) (Const Empty))))"

definition inv__46::"nat \<Rightarrow> formula" where [simp]:
"inv__46 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true))))"

definition inv__47::"nat \<Rightarrow> formula" where [simp]:
"inv__47 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Ident ''CurCmd'')) (Const Empty)) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck))))"

definition inv__48::"nat \<Rightarrow> formula" where [simp]:
"inv__48 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Ident ''ExGntd'')) (Const false))))"

definition inv__49::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__49 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv0) ''Cmd'')) (Const InvAck))))"

definition inv__50::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__50 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const GntE)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const true))))"

definition inv__51::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__51 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv2) ''Cmd'')) (Const InvAck)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const Inv))))"

definition inv__52::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__52 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv0) ''Cmd'')) (Const InvAck))))"

definition inv__53::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__53 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Field (Para (Ident ''Chan3'') p__Inv0) ''Cmd'')) (Const InvAck))))"

definition inv__54::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__54 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv0) ''Cmd'')) (Const Inv)) (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv))) (eqn (IVar (Ident ''ExGntd'')) (Const true))))"

definition inv__55::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__55 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (eqn (IVar (Ident ''ExGntd'')) (Const true))) (eqn (IVar (Para (Ident ''InvSet'') p__Inv0)) (Const true))))"

definition inv__56::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__56 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Para (Ident ''InvSet'') p__Inv0)) (Const true))))"

definition inv__57::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__57 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Para (Ident ''InvSet'') p__Inv0)) (Const true)) (eqn (IVar (Para (Ident ''InvSet'') p__Inv2)) (Const true))) (eqn (IVar (Ident ''ExGntd'')) (Const true))))"

definition inv__58::"nat \<Rightarrow> nat \<Rightarrow> formula" where [simp]:
"inv__58 p__Inv0 p__Inv2 \<equiv>
(neg (andForm (andForm (eqn (IVar (Ident ''ExGntd'')) (Const true)) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv0)) (Const true))) (eqn (IVar (Para (Ident ''ShrSet'') p__Inv2)) (Const true))))"
