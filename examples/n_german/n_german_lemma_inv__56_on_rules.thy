(*  Title:      HOL/Auth/n_german_lemma_inv__56_on_rules.thy
...
lemma lemma_inv__56_on_rules:
  assumes b1: "r \<in> rules N" and b2: "(\<exists> p__Inv0 p__Inv2. p__Inv0\<le>N\<and>p__Inv2\<le>N\<and>p__Inv0~=p__Inv2\<and>f=inv__56  p__Inv0 p__Inv2)"
