(*  Title:      HOL/Auth/n_german_lemma_on_inv__45.thy
...
theory n_german_lemma_on_inv__45 imports n_german_base
begin
section{*All lemmas on causal relation between inv__45 and some rule r*}
lemma n_RecvReqSVsinv__45:
assumes a1: "(\<exists> i. i\<le>N\<and>r=n_RecvReqS N i)" and
a2: "(\<exists> p__Inv2. p__Inv2\<le>N\<and>f=inv__45  p__Inv2)"
shows "invHoldForRule s f r (invariants N)" (is "?P1 s \<or> ?P2 s \<or> ?P3 s")
proof -
from a1 obtain i where a1:"i\<le>N\<and>r=n_RecvReqS N i" apply fastforce done
from a2 obtain p__Inv2 where a2:"p__Inv2\<le>N\<and>f=inv__45  p__Inv2" apply fastforce done
...
lemma n_SendInv__part__0Vsinv__45:
...
lemma n_SendInv__part__1Vsinv__45:
...
moreover {
  assume b1: "(i~=p__Inv2)"
  have "?P3 s"
  apply (cut_tac a1 a2 b1, simp, rule_tac x="(neg (andForm (andForm (eqn (IVar (Field (Para (Ident ''Chan2'') p__Inv2) ''Cmd'')) (Const Inv)) (eqn (IVar (Ident ''CurCmd'')) (Const ReqS))) (eqn (IVar (Ident ''ExGntd'')) (Const false))))" in exI, auto) done
  then have "invHoldForRule s f r (invariants N)" by auto
}
moreover {
  assume b1: "(i~=p__Inv2)"
...
lemma n_SendReqE__part__1Vsinv__45:
...
lemma n_SendReqE__part__0Vsinv__45:
